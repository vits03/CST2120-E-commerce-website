     ...
     <div class="filter-menu"><select name="language" id="language">
      ...
      <div class="product-wrapper">
          ...
          <div class="product-container">
              <div class="btn-container"><a href="productpage.php">View</a><a onclick="openNav()">Add to cart</a></div>
                <img src="..\assets\images\nintendo.jpg" alt="">
                <div class="product-description">Nintendo Switch-128gb 4K</div>
                <div class="product-price">Rs 11,5690</div> 
          </div>
          ...
          <div class="product-container">
            <div class="btn-container"><a href="product-page.html">View</a><a onclick="openNav()">Add to cart</a></div>
              ...
              <div class="product-description">Apple iPhone 14, 128GB, Blue - Unlocked</div>
              <div class="product-price">Rs 87,5690</div> 
        </div>
      
        <div class="product-container">
          <div class="btn-container"><a href="product-page.html">View</a><a onclick="openNav()">Add to cart</a></div>
            <img src="..\assets\images\airpods.jpg" alt="">
            <div class="product-description">Apple AirPods (3rd Generation) </div>
            <div class="product-price">Rs 15,550</div> 
        </div>
