...
db.products.insert([
  ...
  },
  {
    ...
    description: [
      "Google Pixel 7 is powered by Google Tensor G2",
      "it’s faster, more efficient, and more secure, with the best photo and video quality yet on Pixel[1]",
      "Unlocked Android 5G phone gives you the flexibility to change carriers and choose your own data plan[2];",
      "works with Google Fi, Verizon, T-Mobile, AT&T, and other major carriers",
      "Pixel’s Adaptive Battery can last over 24 hours; when Extreme Battery Saver is turned on, it can last up to 72 hours[3]",
      "The 6.3-inch Pixel 7 display is super sharp, with rich, vivid colors",
      "it’s fast and responsive for smoother gaming, scrolling, and moving between apps[4]",
    ],
    price: 47500,
    quantity: 33,
    category: "Mobile Phones",
  ...
  },
  {
    ...
    description: [
      "Unleash the power of 5G | Powered by the latest Qualcomm Snapdragon 8 Gen 1 processor, the 10 Pro is capable of blazing-fast 5G speeds. [5G network only compatible with TMO, Verizon, Google Fi, Mint Mobile] *5G available in selected areas",
  ...
  },
  {
    ...
    description: [
      "The Power of 5G: Experience revolutionary speeds, faster streaming, quicker downloads, as well as enhanced AI features and hyper-accurate GPS with the Qualcomm Snapdragon 750G 5G Mobile processor",
  ...
  },
  {
    ...
    description: [
      "Full High Definition Resolution: Along with its 1080p high-definition LCD screen, you'll find a powerful full array LED backlight at work creating a sharper, more colorful picture..Wall Mount : VESA 100 x 200. Display aspect ratio 16:9",
  ...
  },
  {
    ...
    description: [
      "LG USA AUTHORIZED - Includes Full LG USA Protection",
      "Built-In Wi-Fi Connectivity | Quad-core processor | Active HDR (HDR10, HLG)",
      "IN THE BOX: Remote Control - Stand Assembly",
      "BUNDLE INCLUDES: LG 32 Inch LED HD Smart webOS TV",
  ...
  },
  {
    ...
    description: [
      "Extremely Efficient/Low 12V Power Draw. Multiple 12V connection options. Full 110V Compatibility with Adapter.",
      "Built in Wifi/Internet Access, Bluetooth Connectivity, Integrated SD - DVD Player.",
      "Preloaded Popular Apps (Netflix, Amazon Prime, YouTube, Pandora & More).",
      "Rugged Vibration Resistant Chassis for Trouble-Free Mobile/Off Road Use.",
    ],
    price: 15912,
    quantity: 37,
    category: "Televisions",
    path: "free-tc-transit.jpg",
    isRemoved: false,
  },
  ,
  {
  ...
  },
  {
    ...
    description: [
      "12.9-Inch Edge-to-Edge Liquid Retina Display with ProMotion, True Tone, and P3 Wide Colo  ",
      "A12Z Bionic Chip with Neural Engine - 802.11AX Wi-Fi 6 - Up to 10 Hours of Battery Life/Charge",
      "12MP Wide Camera, 10MP Ultra Wide Camera, 7MP TrueDepth Front Camera, and LIDAR Scanner",
      "Four Speaker Audio and Five Studio-Quality Microphones - Face ID for Secure Authentication and Apple Pay",
    ],
  ...
  },
  {
    ...
    description: [
      "Screen Everyone Will Love: Whether your family is streaming or video chatting with friends, the Galaxy Tab A8 tablet brings out the best in every moment on a 10.5LCD screen  ",
...

  {
    ...
    description: [
      "【8 Core CPU, 8GB+128GB tablet】M40Plus Android 12 tablet is equipped with 8GB RAM +ROM 128GB large capacity, Up to 1TB of storage is available using a MicroSD card(FAT32 formatted, sold separately).  ",
